        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
         ...
         Container(
           decoration: BoxDecoration(
             ...
             Theme.of(context).hintColor.withValues(alpha:.25), blurRadius: 2, spreadRadius: 2, offset: const Offset(1,2))]),
           child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
             Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
               ...
               Padding(padding:  EdgeInsets.only(top : isDetails? 10 : 0),
                 child: Container(margin: const EdgeInsets.only(left: 15, right: 15),
                   decoration: BoxDecoration(
                     border: isDetails? Border.all(color: Theme.of(context).primaryColor.withValues(alpha:.125)): Border.all(width: 0,color: Colors.transparent),
             ...
             if(isDetails)
             Divider(color: Theme.of(context).primaryColor.withValues(alpha:.5), thickness: .15),
             isDetails?
