...
class ProductController extends ChangeNotifier {
  ...
  void _initCategoryCheck() {
    final addProductController = Provider.of<AddProductController>(Get.context!, listen: false);
    final List<CategoryModel> categoryList = addProductController.categoryList ?? [];
