          ...
          child: ClearanceSaleSectionWidget(
            ...
            childrens: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(getTranslated('flat_discount', context)!, style: robotoTitleRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                    ...
                    Expanded(child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(getTranslated('product_wise_discount', context)!, style: robotoTitleRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                        ],
                      ),
                    )),
                  ],
              ...
              if(clearanceController.selectedDiscountType == 1)...[
                Padding(
                  padding: const EdgeInsets.only(left: Dimensions.paddingSizeDefault),
                  child: Text(getTranslated('discount_amount', context)!, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault))
                ),
              ],
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(getTranslated('always_active', context)!, style: robotoTitleRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                          const SizedBox(width: Dimensions.paddingSizeDefault),
                        ],
                      ),
                    ),
                    ...
                    Expanded(child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(getTranslated('specific_time_in_a_day', context)!, style: robotoTitleRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                        ],
                      ),
                    )),
