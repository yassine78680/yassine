                ...
                @if ($order->order_type == 'default_type')
                    ...
                    <tr>
                        ...
                        @if($order->billing_address_data)
                            <td colspan="2" class="fz-10 border-left vertical-align-top" style="padding:8px 16px;">
                                    <?php
                        ...
                        @endif
                        <td colspan="2" class="fz-10 vertical-align-top  {{$direction === "rtl" ? '' : 'border-left'}}" style="padding:8px 16px;">
                            ...
                            @foreach($order->details as $key=>$details)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-nowrap">
                                        <div class="fz-10 text-dark">{{$details->qty}}</div>
                                    </td>
                                    <td class="text-right text-nowrap">
                                        <div class="fz-10 text-dark">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $details['price']), currencyCode: getCurrencyCode()) }}</div>
                                    </td>
                                    <td class="text-right text-nowrap">
                            ...
                            <tr>
                                <th class="text-left" style="width:50%; vertical-align: top;">
                                    <table class="note" style="width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td class="text-left text-dark fz-12">
