...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex justify-content-between align-items-center gap-3 mb-3">
            ...
            <a href="{{ route('frontend.blog.details', ['slug' => $blog['slug'], 'source' => 'edit']) }}" target="_blank" class="btn btn-outline-primary"  data-toggle="tooltip" data-placement="bottom" title=""
            >
                ...
                <div class="card-body">
                    <div class="row mb-lg-4 align-items-center">
                            ...
                            <div class="form-group mb-0">
                                <label for="name" class="title-color d-flex gap-1">
                                    ...
                                    <span class="trx-y-2" data-toggle="tooltip" data-placement="top" title=""
                                          data-original-title="{{ translate('pick_the_date_that_you_want_to_show_for_customers_as_blog_publishing_date') }}">
                                        <img
                                            src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="Image">
                                    </span>
                        ...
                        <div class="col-lg-6">
                            <div class="text-center my-4 my-lg-0">
                                <label
                                    class="fz-14 text-title font-weight-bold">
                                    {{ translate('Thumbnail') }}
                                    ...
                                    <label class="upload-file-wrapper w-100 h-100 mb-0">
                                        <div class="__bg-F9F9F9 upload-file-textbox h-100 w-100 overflow-hidden">
                                            <div
                                                ...
                                                <img src="{{ $blog->is_published ? getStorageImages(path: $blog?->thumbnail_full_url, type:'backend-product') : getStorageImages(path: $blog?->draft_thumbnail_full_url, type:'backend-product') }}" alt="">
                                            </div>
                                        </div>
                    ...
                    <div class="d-flex flex-wrap gap-3 justify-content-end mt-4">
                        <button type="button" id="reset"
                                class="btn btn-secondary font-weight-semibold w-140 reset-form">{{ translate('reset') }}</button>
                        <button type="button" class="btn btn-outline-primary font-weight-semibold w-140 save-draft">{{ translate('Save_to_Draft') }}</button>
                        <button type="button" class="btn btn--primary font-weight-semibold w-140" data-toggle="modal" data-target="#toggle-status-publish-modal">{{ translate('Update_Publish') }}</button>
                    </div>
                </div>
            </div>
        </form>
