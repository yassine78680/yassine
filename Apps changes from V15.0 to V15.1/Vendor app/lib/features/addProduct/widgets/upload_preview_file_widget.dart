                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: DottedBorder(
                          ...
                          color: (!resProvider.isPreviewNull || resProvider.digitalProductPreview != null ) ? Theme.of(context).primaryColor : Theme.of(context).hintColor,
                                            ...
                                            Column(
                                              children: [
                                                ...
                                                Text(resProvider.digitalProductPreview?.name ?? '',
                                                    style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault), overflow: TextOverflow.ellipsis,)
                                              ],
                                            )
                                          ],
