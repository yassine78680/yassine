  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Consumer<OrderDetailsController>(builder: (context, orderDetailsController, _) {
          ...
          return orderDetailsController.orderDetails?[0].order?.orderType == 'POS'  ? const SizedBox() : Container(
            ...
            child: CustomButtonWidget(
              ...
              onTap: (orderDetailsController.orderDetails == null ) ? null : () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => OrderSetupWidget(
