...
<div class="modal fade" id="toggle-status-custom-modal" tabindex="-1" aria-labelledby="toggle-modal" aria-hidden="true" style="z-index: 999999">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            <div class="modal-header border-0 pb-0 d-flex justify-content-end">
                <button type="button" class="btn-close border-0" data-dismiss="modal" aria-label="Close"><i class="tio-clear"></i></button>
            ...
            <div class="modal-body px-4 px-sm-5 pt-0">
                <div class="d-flex flex-column align-items-center text-center gap-2 mb-2">
                    ...
                    <h5 class="modal-title" id="toggle-status-custom-modal-title"></h5>
                ...
                <div class="d-flex justify-content-center gap-3">
                    ...
                    <button type="button" class="btn btn--primary min-w-120 text-capitalize toggle-status-custom-modal-button-text" id="toggle-status-custom-modal-ok-button" data-dismiss="modal">{{ translate('Yes_on') }}</button>
                </div>
            </div>
        </div>
    </div>
